 ...
 */
class RptRekapHarianBPB extends REST_Controller {
    ...
    public function index_get()
    {
        ...
        if ($tgl === NULL)
        {
                ...
                $sql='SELECT A.BPBID,A.TransDate,A.PABID,A.BPBRemark,A.WHSName,A.DeptName,  
                        ...
                        WHERE CONVERT(varchar,TransDate,103) = CONVERT(varchar,' . . ',103)' .
                        'ORDER BY A.ItemID ';
        ...
        private function header($pdf,$bpb) {
                ...
                $table1->easyCell('');
                $table1->easyCell('BPB Harian', 'font-size:12; font-style:B;align:C;colspan:3');
                $table1->easyCell('');
                $table1->printRow();
