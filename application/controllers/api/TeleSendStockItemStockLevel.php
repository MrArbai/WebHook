...
class TeleSendStockItemStockLevel extends REST_Controller
{
    ...
    function NotifRevisiDocno($ItemID) {
        ...
        $sql = 'SELECT GroupItemCode,GroupItemName,SafetyStock,BufferStock,MaximalStock,AvailableStock,Tanggal FROM vwMonItemStockLevel_WithNPBB1 WHERE BufferStock > AvailableStock'. 
       ...
       "AND ISNULL(A.TelegramID,'') <> ''";
        ...
        $url = "https://www.gambaranimasi.org/data/media/1638/animasi-bergerak-tanda-peringatan-0023.gif";
        $url1 = "https://www.gambaranimasi.org/data/media/1638/animasi-bergerak-tanda-peringatan-0014.gif";

    

        if ($LP[0]['SafetyStock'] > $LP[0]['AvailableStock'] )
        {
